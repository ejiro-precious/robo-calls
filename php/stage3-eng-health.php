...
if (isset($_POST) && $_POST['direction'] == "Outbound") {
    if (isset($_POST['dtmfDigits']) && $_POST['isActive'] == "1") {
        ...
        if ($digit == '1') {
            $content = "https://s3.eu-west-2.amazonaws.com/peakramadan/peak_audio/english/tips_on_health/1_health_important.mp3";
        } else if ($digit == '2') {
            $content = "https://s3.eu-west-2.amazonaws.com/peakramadan/peak_audio/english/tips_on_health/2_water.mp3";
        } else if ($digit == '3') {
            $content = "https://s3.eu-west-2.amazonaws.com/peakramadan/peak_audio/english/tips_on_health/3_time_ramadan.mp3";
        } else if ($digit == '4') {
            $content = "https://s3.eu-west-2.amazonaws.com/peakramadan/peak_audio/english/tips_on_health/4_sleep.mp3";
        } else if ($digit == '#') {
            $content = "Return to previous menu";
        } else if ($digit == '0') {
