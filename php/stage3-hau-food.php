...
if (isset($_POST) && $_POST['direction'] == "Outbound") {
    if (isset($_POST['dtmfDigits']) && $_POST['isActive'] == "1") {
        ...
        if ($digit == '1') {
            $content = "https://s3.eu-west-2.amazonaws.com/peakramadan/peak_audio/hausa/food_tips/1_suhoor.mp3";
        } else if ($digit == '2') {
            $content = "https://s3.eu-west-2.amazonaws.com/peakramadan/peak_audio/hausa/food_tips/2_iftar.mp3";
        } else if ($digit == '#') {
