...
if (isset($_POST) && $_POST['direction'] == "Outbound") {
    if (isset($_POST['dtmfDigits']) && $_POST['isActive'] == "1") {
        ...
        if ($digit == '1') {
            $content = "https://s3.eu-west-2.amazonaws.com/peakramadan/peak_audio/english/adhkar_prayers/prayer_on_forgiveness.mp3";
        } else if ($digit == '2') {
            $content = "https://s3.eu-west-2.amazonaws.com/peakramadan/peak_audio/english/adhkar_prayers/prayer_on_victory.mp3";
        } else if ($digit == '3') {
            $content = "https://s3.eu-west-2.amazonaws.com/peakramadan/peak_audio/english/adhkar_prayers/prayer_on_reward.mp3";
        } else if ($digit == '4') {
            $content = "https://s3.eu-west-2.amazonaws.com/peakramadan/peak_audio/english/adhkar_prayers/prayer_on_knowledge.mp3";
        } else if ($digit == '#') {
            $content = "Return to previous menu";
        } else if ($digit == '0') {
