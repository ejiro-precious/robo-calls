...
if (isset($_POST) && $_POST['direction'] == "Outbound") {
    if (isset($_POST['dtmfDigits']) && $_POST['isActive'] == "1") {
        ...
        if ($digit == '1') {
            $content = "https://s3.eu-west-2.amazonaws.com/peakramadan/peak_audio/hausa/adhkar_prayers/menu.mp3";
        } else if ($digit == '2') {
            $content = "https://s3.eu-west-2.amazonaws.com/peakramadan/peak_audio/hausa/99names.mp3";
        } else if ($digit == '3') {
            $content = "https://s3.eu-west-2.amazonaws.com/peakramadan/peak_audio/hausa/food_tips/menu.mp3";
        } else if ($digit == '4') {
            $content = "https://s3.eu-west-2.amazonaws.com/peakramadan/peak_audio/hausa/tips_on_health/menu.mp3";
        } else if ($digit == '#') {
