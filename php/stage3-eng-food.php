    ...
    if (isset($_POST['dtmfDigits']) && $_POST['isActive'] == "1") {
        ...
        switch ($digit) {
            ...
            case '0':
                ...
                break;
            case '#':
                $content = "Go back to previous menu";
                echo '
                <Response>
        ...
        if ($digit == '1') {
            $content = "https://s3.eu-west-2.amazonaws.com/peakramadan/peak_audio/english/food_tips/suhoor_recipe.mp3";
        } else if ($digit == '2') {
            $content = "https://s3.eu-west-2.amazonaws.com/peakramadan/peak_audio/english/food_tips/iftar_recipe.mp3";
        } else if ($digit == '#') {
